...
import { Search, Plus, X, Store as StoreIcon, Check, Trash2, Edit } from 'lucide-react';
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col md:flex-row items-center justify-between mb-6">
        <h1 className="text-2xl font-bold mb-4 md:mb-0">Manage Stores</h1>
            ...
            <tbody>
              {filteredStores.length === 0 ? (
                ...
                filteredStores.map((store) => (
                  <tr key={store.id} className="border-t hover:bg-muted/50 transition-colors">
                    <td className="px-4 py-3 text-sm">{store.name}</td>
                    <td className="px-4 py-3 text-sm">{store.email}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center">
                        ...
                        <span className="ml-2 text-sm">{store.rating.toFixed(1)}</span>
                      </div>
                    </td>
